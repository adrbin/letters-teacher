  ...
  return (
    <main className="page-shell flex min-h-screen items-center justify-center p-4 sm:p-8">
      <section className="w-full max-w-4xl rounded-[2rem] bg-white/92 p-5 text-center shadow-soft ring-1 ring-slate-200 sm:p-8">
        ...
        <h1 className="mt-2 text-4xl font-black text-slate-950 sm:text-6xl">Great work!</h1>
        ...
        <div className="mx-auto mt-7 grid max-w-xl gap-4 rounded-3xl bg-slate-950 p-5 text-white">
          ...
          <div className="h-7 overflow-hidden rounded-full bg-white/20" aria-label={`Accuracy ${summary.accuracy} percent`}>
            <div
        ...
        <div className="mt-7 grid gap-4 text-left sm:grid-cols-2">
          <LetterList title="Strong letters" letters={summary.strongLetters} tone="emerald" />
          <LetterList title="Practice again" letters={summary.practiceLetters} tone="amber" />
        </div>
